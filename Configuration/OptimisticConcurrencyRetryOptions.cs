...
/// </summary>
public sealed record OptimisticConcurrencyRetryOptions : IValidatableOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets whether optimistic concurrency retry is enabled.
    ...
    /// <summary>
    /// Gets the maximum number of retry attempts when a concurrency conflict occurs.
    ...
    /// <summary>
    /// Gets the base delay in milliseconds for the first retry attempt.
    /// Each subsequent retry will use exponential backoff: delay * 2^(attempt - 1).
    /// Must be between 10 and 10000.
    /// Defaults to 50 milliseconds.
    /// </summary>
    public int BaseDelayMilliseconds { get; init; } = 50;
    ...
    /// <summary>
    /// Gets a random jitter factor to add variability to retry delays.
